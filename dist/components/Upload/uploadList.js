...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "reant-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "reant-upload-list-item", key: item.uid },
            ...
            React.createElement("span", { className: "file-status" },
                (item.status === 'uploading' || item.status === 'ready') &&
                    React.createElement(Icon, { icon: "spinner", theme: "primary", spin: true }),
                item.status === 'success' &&
