...
export var Tabs = function (props) {
    ...
    var navClass = classNames('reant-tabs-nav', {
        'nav-line': type === 'line',
        'nav-card': type === 'card',
    });
    var renderNavLinks = function () {
        return React.Children.map(children, function (child, index) {
            ...
            var classes = classNames('reant-tabs-nav-item', {
    ...
    return (React.createElement("div", { className: "reant-tabs ".concat(className) },
        React.createElement("ul", { className: navClass }, renderNavLinks()),
        React.createElement("div", { className: "reant-tabs-content" }, renderContent())));
};
Tabs.defaultProps = {
    defaultIndex: 0,
    type: 'line'
