import React, { FC, ReactElement, useState, useEffect, useRef, ChangeEvent, KeyboardEvent } from "react";
 ...
 export const AutoComplete: FC<AutoCompleteProps> = (props) => {
    ...
    const generateDropdown = () => {
        return (
            ...
            >
                <ul
                    className="reant-suggestion-list"
                >
                    { loading &&
                        <div
    ...
    return (
        <div className="reant-auto-complete" ref={componentRef}>
        <Input
            value={inputValue}
